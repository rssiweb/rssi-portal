                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-select" id="identity_verification" name="identity_verification" <?php echo (($array['identity_verification'] == 'Approved' || empty($array['supporting_document']) || ($array['identity_verification'] == 'Rejected' && !empty($array['supporting_document']) && $array['application_status'] != 'Identity verification document submitted'))) ? 'disabled' : ''; ?>>
