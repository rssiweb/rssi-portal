...
<body>
    ...
    <div class="container mt-5">
        ...
        <br>
        <h2 class="text-center mb-4" style="background-color:#CE1212; color:white; padding:10px;">Associate Appraisal Form-II</h2>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_1'] ?></td>
                                        <td><?php echo $array['manager_remarks_1'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_2'] ?></td>
                                        <td><?php echo $array['manager_remarks_2'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_3'] ?></td>
                                        <td><?php echo $array['manager_remarks_3'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_4'] ?></td>
                                        <td><?php echo $array['manager_remarks_4'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_5'] ?></td>
                                        <td><?php echo $array['manager_remarks_5'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_6'] ?></td>
                                        <td><?php echo $array['manager_remarks_6'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_7'] ?></td>
                                        <td><?php echo $array['manager_remarks_7'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_8'] ?></td>
                                        <td><?php echo $array['manager_remarks_8'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_9'] ?></td>
                                        <td><?php echo $array['manager_remarks_9'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_10'] ?></td>
                                        <td><?php echo $array['manager_remarks_10'] ?></td>
                                    </tr>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_11'] ?></td>
                                        <td><?php echo $array['manager_remarks_11'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_12'] ?></td>
                                        <td><?php echo $array['manager_remarks_12'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_13'] ?></td>
                                        <td><?php echo $array['manager_remarks_13'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_14'] ?></td>
                                        <td><?php echo $array['manager_remarks_14'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_15'] ?></td>
                                        <td><?php echo $array['manager_remarks_15'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_16'] ?></td>
                                        <td><?php echo $array['manager_remarks_16'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_17'] ?></td>
                                        <td><?php echo $array['manager_remarks_17'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_18'] ?></td>
                                        <td><?php echo $array['manager_remarks_18'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_19'] ?></td>
                                        <td><?php echo $array['manager_remarks_19'] ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><?php echo $array['rating_obtained_20'] ?></td>
                                        <td><?php echo $array['manager_remarks_20'] ?></td>
                                    </tr>
                                </tbody>
                            </table>
