...
// Get associate info
$assoc_query = "SELECT * FROM rssimyaccount_members WHERE associatenumber = $1";
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5><?php echo htmlspecialchars($associate['fullname'] ?? ''); ?> (ID: <?php echo htmlspecialchars($associate_number); ?>)</h5>
                    ...
                    <div class="alert alert-info mt-2">
                        <i class="bi bi-info-circle"></i> <strong>Note:</strong> A schedule is active only if it has the latest start date for that day of week. Older schedules are automatically inactive.
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php if ($schedules_count > 0): ?>
                            <?php foreach ($schedules as $row):
                                ...
                                $is_active = ($latest_date_for_workday && $current_date == $latest_date_for_workday);
                            ?>
                                <tr class="<?php echo !$is_active ? 'table-secondary' : ''; ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php if (!$is_active && $latest_date_for_workday): ?>
