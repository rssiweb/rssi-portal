                                            ...
                                            <?php foreach ($resultArr as $array) { ?>
                                                ...
                                                $messages = [
                                                    ...
                                                    'Offer letter reminder' => "As per system records, you have not yet replied to the email with the subject “RSSI Offer Letter - " . $array['associatenumber'] . "_" . $array['fullname'] . "”.\n\n"
                                                        ...
                                                        'Joining Reminder' => "As per system records, your joining date is scheduled for " . (!empty($array['doj']) ? date('d/m/Y', strtotime($array['doj'])) : 'N/A') . ". We are excited to have you on board and would like to remind you of the following pre-joining formalities:\n\n- Please download the soft copy of your ID card from: Account > My Services > My Documents > Miscellaneous > RSSI Identity Card.\n- Please ensure you punch in at the time of reporting and punch out at the time of exit every working day without fail.\n- After reporting, kindly complete your onboarding in the system, as this marks the official start of your tenure.\n- Please connect with your Centre In-Charge to obtain your manager/supervisor details and complete your orientation after joining.\n- Kindly review the Internship Handbook carefully and clarify any doubts regarding your responsibilities and internship expectations.\n- Interns are required to deposit Rs. 150 at the time of onboarding, which is refundable at the time of separation.\n- For any queries, please contact your Centre In-Charge. If the issue remains unresolved, you may email the HR team at info@rssi.in.\n- Google map - https://maps.app.goo.gl/B6VKzykjRukr12te7\n\nWe look forward to having you with us and wish you a rewarding internship experience with RSSI NGO."
                                                ];
                                                ?>
                                                <?php
                                                // Example input dates
