        ...
        <section class="wrapper main-wrapper row">
            <div class="col-md-12">
                <!-- <div class="alert alert-info alert-dismissible" role="alert" style="text-align: -webkit-center;">
                    ...
                    <span class="noticet">The last date for submission of question paper is 3/July/2022. For more details please visit Examination Portal.&nbsp;&nbsp;<span class="badge label-danger blink_me">new</span>
                </div> -->
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="line-height: 2;"><span class=noticea><a href=https://docs.google.com/spreadsheets/d/1ufn8vcA5tcpoVvbTgGBO9NsXmiYgjmz54Qqg_L2GZxI/edit#gid=311270786 target=_blank>Attendance sheet</a></span>
                                        ...
                                        ?>
                                            <span class="badge label-warning" style="display:-webkit-inline-box">pending&nbsp;<?php echo $attd_pending ?></span>
                                        <?php
                                        } else {
                                        }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td style="line-height: 2;">
                                        <span class=noticea>
                                            ...
                                            <a href="policy.php">HR Policies</a>
                                        </span>
                                    </td>
                                </tr>
                            <?php
