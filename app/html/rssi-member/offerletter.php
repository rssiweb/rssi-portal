                    ...
                    <table class="table" border="0">
                        ...
                        <tbody>
                           ...
                           <td>' ?>
                            ...
                            <?php echo 'RSSI/' . $array['associatenumber'] . '/' . $array['depb'] . '<br><br>
...
<ol>
<li>You will be eligible for a gross salary of <b>₹' . $array['salary'] / 12 . '/- per month</b>.</li>
...
<li>' ?>
                            <?php if ($array['engagement'] == 'Intern') { ?>
                                <?php echo 'You will be liable to pay RSSI ₹5000/- in case you fail to serve RSSI for at least 1 month from the original joining date in accordance with the Service Agreement clause.' ?>
                            <?php } else if ($array['engagement'] == 'Employee' && substr($array['position'], 0, strrpos($array['position'], "-")) == 'Employee-Faculty cum Centre Incharge') { ?>
                                <?php echo 'You will be liable to pay RSSI ₹5000/- in case you fail to serve RSSI for at least 4 month from the original joining date in accordance with the Service Agreement clause.' ?>
                            ...
                            <?php if (str_contains($array['position'], "Intern")) { ?>
                                <?php echo '4 days a week, 2 hours per day' ?>
                            <?php } else if (str_contains($array['position'], "Employee")) { ?>
                                <?php echo '6 days a week, 2 hours per day + Administrative activities as required.' ?>
                            <?php } else if (str_contains($array['position'], "Volunteer")) { ?>
                                <?php echo '3 days a week, 2 hours per day' ?>
                            <?php }
                            echo
                            '<br>The working hours can be extended up to a maximum of 30 minutes depending on the real time situation for other activities including prayer, and management i.e. student admission, and other non-academic activities etc. You should be flexible in terms of working hours.</li>
<li>Primary responsibility —
Responsible for teaching students, conducting tests and meetings, solving problems, evaluating students, and helping them improve their skills.<br>' ?>
                            <?php if (str_contains($array['position'], "Intern")) { ?>
                                <?php echo '<a href="https://drive.google.com/file/d/1UV1Y9d0w1dFh4YYV2Cj4pPpLTEUoCT7_/view" target="_blank">Responsibilities of the Teaching Intern</a>' ?>
                            <?php } else if (str_contains($array['position'], "Centre Incharge")) { ?>
                                <?php echo '<a href="https://drive.google.com/file/d/1VOuqKRhyy3hycuiIMi022qKAzvPVd4dw/view" target="_blank">Responsibilities of Centre In charge / Asst. centre in-charge</a><br><a href="https://drive.google.com/file/d/1dhzOnSjyI4CgmY5AnLprJRCcGvBUvRuj/view" target="_blank">Responsibilities of the Teaching staff</a>' ?>
                            <?php } else if (str_contains($array['position'], "Employee")) { ?>
                                <?php echo '<a href="https://drive.google.com/file/d/1dhzOnSjyI4CgmY5AnLprJRCcGvBUvRuj/view" target="_blank">Responsibilities of the Teaching staff</a>' ?>
                            <?php } else if (str_contains($array['position'], "Volunteer")) { ?>
                                <?php echo '<a href="https://drive.google.com/file/d/1dhzOnSjyI4CgmY5AnLprJRCcGvBUvRuj/view" target="_blank">Responsibilities of the Teaching staff</a>' ?>
                            <?php }
                            echo
...
<li>By accepting this offer letter you are also accepting all HR policies applicable to RSSI ' . $array['engagement'] . ' like PoSH, Leave Policy etc. HR can take action in case of any non-compliance.</li>
...
<li>Your association will be governed by and constructed in accordance with the laws of India and the courts of Kharagpur, West Bengal alone will have the jurisdiction.</li>
                            ...
                            <?php if (str_contains($array['position'], "Employee")) { ?>
                                ...
                                <?php echo '<p><b><u>Increments and Promotions</u></b></p>
...
<p>Sincerely,</p> 
                        ...
                        <tfoot>
                            <tr>
                                <td>
                                    <p class="report-footer"><?php echo 'RSSI/' . $array['associatenumber'] . '/' . $array['depb'] . '</p>' ?>
                                        <?php echo '<p style="margin-top:5%;">Signature of the Associate</p><p>Date&nbsp;(dd/mm/yyyy)&nbsp;&#8212;</p>
                            </td>
                            </tr>
                      </tfoot>     
                    </table>' ?>
