    ...
    <div class="container">
        <form method="get" name="a_lookup" id="a_lookup">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Enter the application number to search for their information.</div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 text-end">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#joining-letter-modal-<?php echo $array['certificate_no']; ?>">
                                            Resume
                                        </a><br>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#joining-letter-modal-<?php echo $array['certificate_no']; ?>">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><strong>Application Number:</strong> <?php echo $array['associatenumber'] ?></p>
                                                <p><strong>Date of Interview:</strong> <?php echo date('M d, Y', strtotime($array['doj'])) ?></p>
                                            </div>

                                            <div class="col-md-6">
                                                <p><strong>Engagement:</strong> <?php echo $array['engagement']; ?></p>
                                                <p><strong>Post applied for:</strong> <?php echo implode('-', array_slice(explode('-',  $array['position']), 0, 2)); ?></p>
                                                <p><strong>Interview Branch:</strong> <?php echo $array['depb']; ?></p>
