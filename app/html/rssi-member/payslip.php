...
if ($role == 'Admin') {
    ...
    if ($row = pg_fetch_assoc($result)) {
        ...
        $query = "SELECT employeeid, 
                ...
                AND (payyear < $2 OR (payyear = $2 AND paymonth <= $1)) -- Adjusted condition
                                ...
                                <td style="border: none;">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            $last_three_rows = array_slice($all_rows, -3);
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Bonus Information</h1>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($all_rows as $row) : ?>
                                            <tr>
                                                <td><?php echo htmlspecialchars($row['pay_month']); ?></td>
                                                <td><?php echo htmlspecialchars($row['monthly_bonus_amount']); ?></td>
                                                <td><?php echo htmlspecialchars($row['monthly_payout_bonus']); ?></td>
                                                <td><?php echo htmlspecialchars($row['balance_bonus']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
