                ...
                <?php if ($role == 'Admin') { ?>
                    ...
                    <?php
                        ...
                        <div class="alert alert-success alert-dismissible" role="alert" style="text-align: -webkit-center;">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <i class="glyphicon glyphicon-ok" style="font-size: medium;"></i></span>&nbsp;&nbsp;<span>Database has been updated successfully for policy id <?php echo @$policyid ?>.</span>
                        </div>
                        <script>
                                ...
                                <div class="form-group" style="display: inline-block;">
                                    <div class="col2" style="display: inline-block;">
                                        ...
                                        <span class="input-help">
                                            <select name="policytype" class="form-control" style="width:max-content; display:inline-block" required>
                    ...
                    <table class="table" id="table-id" style="font-size:12px;">
                        ...
                        foreach ($resultArr as $array) {
                            ...
                            <tr>
                                ...
                                <td>' . $array['policyname'] . '&nbsp;<p class="label label-default">' . $array['policytype'] . '</p></td>
                                <td>
                            ...
                            <?php if ($role == 'Admin') { ?>
                                ...
                                <button type="button" id="edit_' . $array['policyid'] . '" style="display: -webkit-inline-box; width:fit-content; word-wrap:break-word;outline: none;background: none; padding: 0px; border: none;" title="Edit"><i class="fa-regular fa-pen-to-square"></i></button>&nbsp;

                                <button type="submit" id="save_' . $array['policyid'] . '" style="display: -webkit-inline-box; width:fit-content; word-wrap:break-word;outline: none;background: none; padding: 0px; border: none;" title="Save"><i class="fa-regular fa-floppy-disk"></i></button>
