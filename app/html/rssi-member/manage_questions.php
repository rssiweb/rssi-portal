...
<div class="container mt-5">
    ...
    <form method="GET" id="filterForm" class="mb-4">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <label for="keywordFilter" class="form-label">Keyword</label>
                <input type="text" id="keywordFilter" name="keyword" class="form-control" placeholder="Search question...">
            </div>
            <div class="col-md-4">
        ...
        <div class="mt-3">
            ...
            <a href="manage_questions.php" class="btn btn-secondary">Reset</a>
        </div>
    </form>
