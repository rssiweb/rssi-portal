...
if (isset($_POST['login'])) {
    ...
    if ($newpass == $oldpass) {
        ...
        $query = "select password from test_users WHERE id='$id'";
        ...
        if ($loginSuccess) {
            ...
            $change_password_query = "UPDATE test_users SET password='$newpass_hash', password_updated_by='$id', password_updated_on='$now' where id='$id'";
            ...
            <div class="card-body">
                <div class="col-md-12">
                    ...
                    <!-- <div class="row mt-3 mb-2">
                        <div class="col text-end text-muted fs-6">
                            Last password updated on:
                            <?= htmlspecialchars(date("d/m/Y g:i a", strtotime($password_updated_on))) ?>
                        </div>
                    </div> -->
                    <!-- Popup -->
