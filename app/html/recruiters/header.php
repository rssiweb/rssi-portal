      ...
      <li class="nav-item dropdown pe-3">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          ...
          if (!empty($applicant_photo)) {
            ...
            $name_parts = explode(" ", $recruiter_name);
          ...
          <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $recruiter_name ?></span>
        </a>

        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          <li class="dropdown-header">
            <h6><?php echo $recruiter_name ?></h6>
            <span>Role :&nbsp;User</span>
          </li>
          <li>
...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" id="job-add" href="job-add.php">
