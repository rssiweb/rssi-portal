...
if (isset($_POST['login'])) {
    ...
    if ($newpass == $oldpass) {
        ...
        $query = "select password from recruiters WHERE id='$recruiter_id'";
        ...
        if ($loginSuccess) {
            ...
            $change_password_query = "UPDATE recruiters SET password='$newpass_hash', password_updated_by='$recruiter_id', password_updated_on='$now' where id='$recruiter_id'";
...
<?php if (@$newpass == null) { ?>
    <div class="alert alert-info alert-dismissible" role="alert" style="text-align: -webkit-center;">
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
        <span>Hi <?php echo $recruiter_name ?>&nbsp;(<?php echo $recruiter_id ?>),&nbsp;Please change your default password.</span>
    </div>
<?php } ?>
