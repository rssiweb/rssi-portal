...
try {
    ...
    try {
        $adminQuery = "SELECT alt_email FROM rssimyaccount_members WHERE position IN ('Admin', 'Centre Incharge') AND filterstatus = 'Active'";
        ...
        if ($adminResult && pg_num_rows($adminResult) > 0) {
            ...
            if (!empty($adminEmails)) {
                ...
                error_log("Notification email sent to admin(s)");
            }
        }
    } catch (Exception $e) {
